...
<p>Descobri que uma das maneiras mais limpas de implementar temas é usando variáveis CSS e atributos HTML. Fiz uma pequena demo usando essa abordagem. =)</p>
...
<iframe width="100%" height="300" src="//jsfiddle.net/mileine/vambtxy7/35/embedded/result/dark/" allowfullscreen="allowfullscreen" allowpaymentrequest frameborder="0"></iframe>
