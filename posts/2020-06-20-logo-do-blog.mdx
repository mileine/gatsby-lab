...
Algo que pode parecer tão pequeno aos olhos alheios, para mim, carrega muito significado. Neste trabalho, coloquei todo o amor que tenho por esse caminho que estou só começando a trilhar em Front-End, meu desejo de aprender todos os dias e minha gratidão poder evoluir numa área que eu mesma escolhi.

E este trabalho, dedico de coração para a pequena Mi de 15 anos, aquela em quem sempre penso quando ouço a música da <a href="/rene-liu-letter/">Rene Lui</a>. Aquela que já gostava da web. Gostava de fazer sites usando *Comic Sans*, achava que design era usar muito ``<frame>``, ``blink``, ``marquee`` e GIFs de estrela como *background*. E que domínio legal era **.cjb.net**. 
